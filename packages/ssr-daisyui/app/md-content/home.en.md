...
- **[remix-i18next](https://sergiodxa.github.io/remix-i18next/)**: Internationalization framework
  for multi-language support, with typesafe translation keys extracted and generated by
  **[i18next-cli](https://github.com/i18next/i18next-cli)** (run `yarn i18n:extract`)
...
- **[Base UI](https://base-ui.com)**: Headless, accessible component primitives. Use DaisyUI classes
  alone for simple components; for complex, interactive ones (dropdowns, dialogs, menus, selects, …)
  build on Base UI for behavior and style it with DaisyUI classes
