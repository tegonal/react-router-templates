...
#
#    __                          __
#   / /____ ___ ____  ___  ___ _/ /       This script is provided to you by https://github.com/tegonal/react-router-templates
...
unset CDPATH
REACT_ROUTER_TEMPLATE_LATEST_VERSION="main"
...
function gt_pullHook_tegonal_gh_commons_before() {
	...
	replaceTegonalGhCommonsPlaceholders_Tegonal "$source" "react-router-templates" "$REACT_ROUTER_TEMPLATE_LATEST_VERSION" "react-router-templates"
}
